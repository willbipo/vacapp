...
INSERT IGNORE INTO insumos (id, nombre, categoria, unidad_medida, cantidad, cantidad_minima, descripcion, proveedor, precio_unitario, ubicacion, tenant_id) VALUES 
    ('960e8400-e29b-41d4-a716-446655440001', 'Pienso concentrado 18%', 'Alimentos', 'SACO', 50, 10, 'Alimento balanceado para ganado lechero', 'Proveeduría García', 25.50, 'Bodega A', 'default'),
    ('960e8400-e29b-41d4-a716-446655440002', 'Sal mineralizada', 'Alimentos', 'KILOGRAMO', 100, 20, 'Sales minerales para suplementación', 'Química Rural', 5.99, 'Bodega B', 'default'),
    ('960e8400-e29b-41d4-a716-446655440003', 'Forraje seco', 'Alimentos', 'TONELADA', 15, 3, 'Heno de calidad premium', 'Forrajes del Sur', 150.00, 'Silos', 'default'),
    ('960e8400-e29b-41d4-a716-446655440004', 'Jeringa 10cc', 'Medicamentos', 'UNIDAD', 200, 50, 'Jeringas desechables estériles', 'LabMédi', 0.85, 'Botiquín', 'default'),
    ('960e8400-e29b-41d4-a716-446655440005', 'Amoxicilina inyectable', 'Medicamentos', 'UNIDAD', 30, 10, 'Antibiótico para ganado', 'LabMédi', 8.50, 'Botiquín', 'default'),
    ('960e8400-e29b-41d4-a716-446655440006', 'Marcador para ganado rojo', 'Herramientas', 'UNIDAD', 15, 3, 'Marcador de pintura para identificación', 'Herramientas Pro', 12.00, 'Taller', 'default'),
    ('960e8400-e29b-41d4-a716-446655440007', 'Tenazas de ordeño', 'Equipos', 'UNIDAD', 8, 2, 'Tenazas de alta resistencia', 'Equipos Agro', 45.00, 'Taller', 'default'),
    ('960e8400-e29b-41d4-a716-446655440008', 'Cuerda de nylon 50m', 'Herramientas', 'ROLLO', 20, 5, 'Cuerda resistente para amarres', 'Herramientas Pro', 35.00, 'Bodega C', 'default'),
    ('960e8400-e29b-41d4-a716-446655440009', 'Desinfectante de ubre', 'Medicamentos', 'LITRO', 25, 5, 'Desinfectante para limpieza de ubres', 'HigienePro', 18.50, 'Botiquín', 'default'),
    ('960e8400-e29b-41d4-a716-446655440010', 'Vitaminas AD3E', 'Medicamentos', 'LITRO', 12, 3, 'Complejo vitamínico para ganado', 'NutriBest', 42.00, 'Botiquín', 'default'),
    ('960e8400-e29b-41d4-a716-446655440011', 'Escoba para ordeño', 'Herramientas', 'UNIDAD', 10, 2, 'Escoba de fibra natural', 'Herramientas Pro', 8.50, 'Taller', 'default'),
    ('960e8400-e29b-41d4-a716-446655440012', 'Baldes de 20L', 'Equipos', 'UNIDAD', 30, 10, 'Balde plástico con tapa', 'Equipos Agro', 12.00, 'Bodega A', 'default'),
    ('960e8400-e29b-41d4-a716-446655440013', 'Antiséptico yodado', 'Medicamentos', 'LITRO', 8, 2, 'Antiséptico para heridas', 'HigienePro', 22.00, 'Botiquín', 'default'),
    ('960e8400-e29b-41d4-a716-446655440014', 'Cartuchos para inyectora', 'Herramientas', 'UNIDAD', 50, 15, 'Cartuchos para pistola de inyección', 'Equipos Agro', 0.50, 'Taller', 'default'),
    ('960e8400-e29b-41d4-a716-446655440015', 'Suero fisiológico', 'Medicamentos', 'LITRO', 20, 5, 'Suero para hidratación', 'LabMédi', 15.00, 'Botiquín', 'default'),
    ('960e8400-e29b-41d4-a716-446655440016', 'Arete numérico rojo', 'Herramientas', 'UNIDAD', 500, 100, 'Aretes numerados para identificación', 'Identificadores Rural', 0.75, 'Almacén', 'default'),
    ('960e8400-e29b-41d4-a716-446655440017', 'Almohadilla de ordeño', 'Equipos', 'UNIDAD', 20, 5, 'Almohadilla de goma para ordeñadora', 'Equipos Agro', 28.00, 'Taller', 'default'),
    ('960e8400-e29b-41d4-a716-446655440018', 'Guantes de ordeño', 'Herramientas', 'PAR', 100, 20, 'Guantes de látex para ordeño', 'HigienePro', 2.50, 'Taller', 'default'),
    ('960e8400-e29b-41d4-a716-446655440019', 'Agua oxigenada 1L', 'Medicamentos', 'LITRO', 40, 10, 'Agua oxigenada para desinfección', 'Química Rural', 4.50, 'Botiquín', 'default'),
    ('960e8400-e29b-41d4-a716-446655440020', 'Alcohol al 70%', 'Medicamentos', 'LITRO', 35, 8, 'Alcohol para limpieza y desinfección', 'Química Rural', 6.00, 'Botiquín', 'default');
...
INSERT IGNORE INTO vacunas (id, nombre, tipo, laboratorio, descripcion, dosis, via_administracion, lote, fecha_caducidad, stock, unidad_medida, temperatura_almacenamiento, intervalo_dias, tenant_id) VALUES 
    ...
    ('a60e8400-e29b-41d4-a716-446655440003', 'Tuberculina', 'BACTERIANA', 'DiagnostiVet', 'Diagnóstico de tuberculosis', '0.1ml', 'INTRADERMICA', 'LT-2026-001', '2027-02-28', 100, 'UNIDAD', '2-8°C', 14, 'default'),
    ...
    ('a60e8400-e29b-41d4-a716-446655440009', 'Paratuberculosis (Johne)', 'BACTERIANA', 'DiagnostiVet', 'Diagnóstico de paratuberculosis', '0.1ml', 'INTRADERMICA', 'LP-2026-001', '2027-01-20', 80, 'UNIDAD', '2-8°C', 21, 'default'),
...
INSERT IGNORE INTO historial_clinico (id, animal_id, vacuna_id, nombre_vacuna, dosis, via_administracion, lote, fecha_aplicacion, proxima_dosis, notas, aplicado_por, tenant_id) VALUES 
    ...
    ('d60e8400-e29b-41d4-a716-446655440003', 'b60e8400-e29b-41d4-a716-446655440003', 'a60e8400-e29b-41d4-a716-446655440003', 'Tuberculina', '0.1ml', 'INTRADERMICA', 'LT-2026-001', '2024-03-05', '2024-03-19', 'Prueba diagnóstica', 'Dra. López', 'default'),
    ...
    ('d60e8400-e29b-41d4-a716-446655440009', 'b60e8400-e29b-41d4-a716-446655440009', 'a60e8400-e29b-41d4-a716-446655440009', 'Paratuberculosis', '0.1ml', 'INTRADERMICA', 'LP-2026-001', '2024-07-02', '2024-07-23', 'Diagnóstico negativo', 'Dra. López', 'default'),
